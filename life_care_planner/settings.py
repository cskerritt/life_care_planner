"""
Django settings for The Life Care Planner project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-kCjkJW7hPEp232wS56L3mxFJCRPntVMag2PLs9mc")
...
ROOT_URLCONF = "life_care_planner.urls"
...
WSGI_APPLICATION = "life_care_planner.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="life_care_planner"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "life_care_planner_language"
LANGUAGES = [
...
EMAIL_SUBJECT_PREFIX = "[The Life Care Planner] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "The Life Care Planner",
    "DESCRIPTION": "The application is for developing and generating life care planning tables.",
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("The Life Care Planner"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("The application is for developing and generating life care planning tables."),
...
ADMINS = [("Chris Skerritt", "christophertskerritt@gmail.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "life_care_planner": {
            "handlers": ["console"],
            "level": env("LIFE_CARE_PLANNER_LOG_LEVEL", default="INFO"),
        },
    },
}
